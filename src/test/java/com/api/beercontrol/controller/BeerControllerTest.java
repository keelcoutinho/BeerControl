package com.api.beercontrol.controller;
...
import com.api.beercontrol.builder.BeerDTOBuilder;
import com.api.beercontrol.dto.BeerDTO;
import com.api.beercontrol.dto.QuantityDTO;
import com.api.beercontrol.exception.BeerNotFoundException;
import com.api.beercontrol.service.BeerService;
...
public class BeerControllerTest {
    ...
    @InjectMocks
    private BeerControllerTest beerController;
	...
	private byte[] asJsonString(QuantityDTO quantityDTO) {
		return null;
	}

	private byte[] asJsonString(BeerDTO beerDTO) {		
		return null;
	}

	public static String getBeerApiSubpathDecrementUrl() {
		return BEER_API_SUBPATH_DECREMENT_URL;
	}
